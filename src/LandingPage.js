...
export default function LandingPage({ onLoginClick }) {
  const handleDemoClick = () => {
    window.location.href = "mailto:sale@titanassets.dev?subject=Kinetic%20Cards%20Demo%20Request";
  };
  ...
  return (
    <div style={{ 
      ...
      <div style={{ position: 'fixed', top: '-20%', left: '-10%', width: '50vw', height: '50vw', background: 'radial-gradient(circle, rgba(0,82,204,0.15) 0%, rgba(0,0,0,0) 70%)', zIndex: 0, pointerEvents: 'none' }}></div>
      <div style={{ position: 'fixed', bottom: '-20%', right: '-10%', width: '50vw', height: '50vw', background: 'radial-gradient(circle, rgba(52,199,89,0.1) 0%, rgba(0,0,0,0) 70%)', zIndex: 0, pointerEvents: 'none' }}></div>

      {/* NAVIGATION */}
      <nav style={{ position: 'relative', zIndex: 10, display: "flex", justifyContent: "space-between", alignItems: "center", padding: "24px 40px", maxWidth: "1400px", margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <div style={{ background: "rgba(0, 122, 255, 0.1)", border: "1px solid rgba(0,122,255,0.4)", width: "40px", height: "40px", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 0 20px rgba(0,122,255,0.2)" }}>
            <Zap size={20} color="#007aff" />
          </div>
          <span style={{ fontWeight: "900", fontSize: "24px", letterSpacing: "1px", textShadow: "0 0 20px rgba(255,255,255,0.3)" }}>
            KINETIC<span style={{ color: "#007aff" }}>CARDS</span>
          </span>
        </div>
        <div style={{ display: "flex", gap: "16px" }}>
          <button onClick={onLoginClick} style={{ backgroundColor: "rgba(255,255,255,0.05)", color: "#fff", border: "1px solid rgba(255,255,255,0.1)", padding: "10px 24px", borderRadius: "30px", fontWeight: "600", cursor: "pointer", backdropFilter: "blur(10px)" }}>Sign In</button>
          <button onClick={handleDemoClick} style={{ backgroundColor: "#007aff", color: "#fff", border: "none", padding: "10px 24px", borderRadius: "30px", fontWeight: "700", cursor: "pointer", boxShadow: "0 0 15px rgba(0,122,255,0.4)" }}>Request Demo</button>
        </div>
      </nav>

      {/* HERO SECTION */}
      <section style={{ position: 'relative', zIndex: 10, textAlign: "center", padding: "100px 20px 60px 20px", maxWidth: "1000px", margin: "0 auto" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", backgroundColor: "rgba(0,122,255,0.1)", border: "1px solid rgba(0,122,255,0.3)", padding: "8px 20px", borderRadius: "30px", fontSize: "12px", color: "#007aff", fontWeight: "800", letterSpacing: "0.1em", marginBottom: "32px", boxShadow: "0 0 20px rgba(0,122,255,0.15)" }}>
          <Cpu size={14} /> NEXT-GEN OPERATIONS COMMAND
        </div>
        <h1 style={{ fontSize: "clamp(48px, 6vw, 80px)", fontWeight: "900", letterSpacing: "-0.04em", lineHeight: "1.05", marginBottom: "24px", color: "#fff", textShadow: "0 4px 40px rgba(255,255,255,0.2)" }}>
          Total visibility.<br />
          <span style={{ background: "linear-gradient(90deg, #007aff, #00e5ff)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", filter: "drop-shadow(0 0 20px rgba(0,229,255,0.4))" }}>Zero blind spots.</span>
        </h1>
        <p style={{ color: "#a1a1a6", fontSize: "20px", maxWidth: "700px", margin: "0 auto 40px auto", lineHeight: "1.5" }}>
          Track equipment, manage dynamic stock, and schedule automated preventative maintenance from a single, unified HUD.
        </p>
      </section>

      {/* BENTO BOX GRID */}
      <section style={{ position: 'relative', zIndex: 10, maxWidth: "1400px", margin: "0 auto 100px auto", padding: "0 20px" }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '24px' }}>
          
          {/* TRACKING MODULE (LARGE WIDE BOX) */}
          <div style={{ gridColumn: '1 / -1', background: 'rgba(28, 28, 30, 0.4)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '32px', padding: '40px', display: 'flex', flexWrap: 'wrap', gap: '40px', alignItems: 'center', boxShadow: '0 20px 40px rgba(0,0,0,0.4)' }}>
            <div style={{ flex: '1 1 400px' }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#007aff', fontSize: '13px', fontWeight: '800', letterSpacing: '0.1em', marginBottom: '16px' }}>
                <Navigation size={16} /> MODULE 01: KINETIC TRACKING
              </div>
              <h2 style={{ fontSize: "36px", fontWeight: "800", marginBottom: "20px", lineHeight: "1.1" }}>Live Geofence Watchdog</h2>
              <p style={{ color: "#86868b", fontSize: "16px", lineHeight: "1.6", marginBottom: "24px" }}>
          ...
          {/* ASSETS MODULE (HALF BOX) */}
          <div style={{ background: 'rgba(28, 28, 30, 0.4)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '32px', padding: '40px', display: 'flex', flexDirection: 'column', gap: '30px', boxShadow: '0 20px 40px rgba(0,0,0,0.4)' }}>
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#ffcc00', fontSize: '13px', fontWeight: '800', letterSpacing: '0.1em', marginBottom: '16px' }}>
                <Wrench size={16} /> MODULE 02: KINETIC ASSETS
              </div>
              <h2 style={{ fontSize: "28px", fontWeight: "800", marginBottom: "12px", lineHeight: "1.2" }}>Chain-of-Custody</h2>
              <p style={{ color: "#86868b", fontSize: "15px", lineHeight: "1.5" }}>
                Automated PM checklists and immutable digital handoffs. Lock overdue tools from field checkout until maintenance is logged.
              </p>
            </div>
            <div style={{ width: '100%' }}>
              <DemoAssetCard />
          ...
          {/* INVENTORY MODULE (HALF BOX) */}
          <div style={{ background: 'rgba(28, 28, 30, 0.4)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '32px', padding: '40px', display: 'flex', flexDirection: 'column', gap: '30px', boxShadow: '0 20px 40px rgba(0,0,0,0.4)' }}>
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#34c759', fontSize: '13px', fontWeight: '800', letterSpacing: '0.1em', marginBottom: '16px' }}>
                <Boxes size={16} /> MODULE 03: KINETIC INVENTORY
              </div>
              <h2 style={{ fontSize: "28px", fontWeight: "800", marginBottom: "12px", lineHeight: "1.2" }}>Smart FIFO Rotation</h2>
              <p style={{ color: "#86868b", fontSize: "15px", lineHeight: "1.5" }}>
