...
export default function LandingPage({ onLoginClick }) {
  ...
  return (
    <div style={pageStyle}>
      <style>{`
        .card-perspective-wrapper { perspective: 1200px; width: 100%; max-width: 440px; margin: 0 auto; display: flex; }
        ...
        .card-back { transform: rotateY(180deg); position: absolute; top: 0; left: 0; height: 100%; background-color: #1a1a1c; border: 1px solid #3a3a3c; display: flex; flex-direction: column; padding: 24px; overflow-y: auto; }
      ...
      <section style={{
        ...
        <p style={{
          ...
          Test drive our full-size interactive demo cards below! Deploy all three integrated suites or select strictly the module your enterprise needs.
        </p>
      ...
      <section style={{ maxWidth: "1240px", margin: "20px auto 100px auto", padding: "0 20px" }}>
        ...
        {activeTab === "tracking" && (
          <div style={{
            ...
            gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "48px", alignItems: "center"
          }}>
            <div>
              ...
              <ul style={{ display: "flex", flexDirection: "column", gap: "12px", paddingLeft: 0, listStyle: "none" }}>
                <li style={{ display: "flex", alignItems: "flex-start", gap: "10px", fontSize: "15px" }}>
            ...
            {/* FULL-SIZE INTERACTIVE TRACKING CARD */}
            <div className="card-perspective-wrapper">
              <div className={`card-flipper ${trackingFlipped ? 'flipped' : ''}`}>
                
                {/* FRONT FACE */}
                <div className="card-face card-front" style={{ backgroundColor: '#2c2c2e', border: '1px solid #3a3a3c', padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span style={{ fontWeight: '700', fontSize: '18px' }}>LAS-01 — Mobile Node</span>
                    <span style={{ backgroundColor: watchdogActive ? 'rgba(52,199,89,0.15)' : 'rgba(255,59,48,0.15)', color: watchdogActive ? '#34c759' : '#ff3b30', padding: '4px 10px', borderRadius: '6px', fontSize: '11px', fontWeight: '800', display: 'flex', alignItems: 'center', gap: '6px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '12px' }}>
                    <div style={{ fontSize: '13px', color: '#86868b', lineHeight: '1.5' }}>
                      <div style={{ color: '#fff', fontWeight: '600', fontSize: '14px' }}>Las Vegas, NV</div>
                      <div>ID: 862605278000318</div>
                      <div>Group: Fleet Alpha</div>
                      {hasAnchor && <div style={{ color: '#007aff', fontSize: '12px', fontWeight: '700', marginTop: '6px' }}>📍 Anchor: 36.0788, -115.1917</div>}
                    </div>
                    
                    <div style={{ position: 'relative', height: '100px', borderRadius: '8px', overflow: 'hidden', border: '1px solid #3a3a3c', backgroundColor: '#121212' }}>
                  ...
                  {/* Battery Spark Bar */}
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', backgroundColor: '#121212', padding: '8px 14px', borderRadius: '8px', border: '1px solid #3a3a3c' }}>
                    <div style={{ width: '50px', height: '6px', backgroundColor: '#2c2c2e', borderRadius: '3px', overflow: 'hidden' }}>
                      <div style={{ width: '99%', height: '100%', backgroundColor: '#34c759' }} />
                    </div>
                    <span style={{ fontSize: '13px', fontWeight: '700', color: '#34c759' }}>99%</span>
                    <span style={{ fontSize: '12px', color: '#86868b' }}>Est. 18 mos remaining</span>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: '8px', marginTop: 'auto' }}>
                    <button 
                      ...
                      style={{ flex: 1, padding: '10px 8px', borderRadius: '8px', border: '1px solid #fff', backgroundColor: watchdogActive ? '#1d1d1f' : 'transparent', color: '#fff', fontSize: '12px', fontWeight: '700', cursor: 'pointer' }}
                    >
                    ...
                    <button 
                      ...
                      style={{ flex: 1, padding: '10px 8px', borderRadius: '8px', border: '1px solid #fff', backgroundColor: 'transparent', color: '#fff', fontSize: '12px', fontWeight: '700', cursor: 'pointer' }}
                    >
                    ...
                    <button 
                      ...
                      style={{ padding: '10px 16px', borderRadius: '8px', border: '1px solid #007aff', backgroundColor: '#007aff', color: '#fff', fontSize: '12px', fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' }}
                    >
                ...
                <div className="card-face card-back">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #3a3a3c', paddingBottom: '12px', marginBottom: '16px' }}>
                    <span style={{ fontSize: '15px', fontWeight: '700', color: '#007aff' }}>⚙️ Escalate Live Tracking</span>
                    <button onClick={() => setTrackingFlipped(false)} style={{ background: 'none', border: 'none', color: '#86868b', cursor: 'pointer', fontSize: '13px' }}>⤶ Back</button>
                  </div>
                  ...
                  <input type="email" placeholder="investigator@agency.gov" style={{ padding: '12px 14px', borderRadius: '8px', border: '1px solid #3a3a3c', backgroundColor: '#121212', color: '#fff', fontSize: '13px', outline: 'none', marginBottom: '16px', width: '100%', boxSizing: 'border-box' }} />

                  {shareSimulated && (
                    <div style={{ backgroundColor: 'rgba(52,199,89,0.15)', border: '1px solid #34c759', padding: '10px', borderRadius: '8px', fontSize: '12px', color: '#34c759', marginBottom: '16px' }}>
                      ✅ Token Generated! Expiration set for 24 Hours.
                    </div>
                  )}

                  <button onClick={() => setShareSimulated(!shareSimulated)} style={{ marginTop: 'auto', padding: '12px', borderRadius: '8px', border: 'none', backgroundColor: '#007aff', color: '#fff', fontSize: '13px', fontWeight: '700', cursor: 'pointer' }}>
        ...
        {activeTab === "tools" && (
          <div style={{
            ...
            {/* FULL-SIZE INTERACTIVE TOOLS CARD */}
            <div className="card-perspective-wrapper">
              <div className={`card-flipper ${toolsFlipped ? 'flipped' : ''}`}>
                ...
                <div className="card-face card-front" style={{ backgroundColor: '#2c2c2e', border: '1px solid #3a3a3c', padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <span style={{ fontSize: '13px', color: '#86868b' }}>[ CAT-259D3 ]</span>
                  </div>

                  <div>
                    <div style={{ fontSize: '20px', fontWeight: '800', color: '#fff' }}>Caterpillar Track Loader</div>
                    <div style={{ fontSize: '13px', color: '#86868b' }}>Valued at $65,000</div>
                  </div>

                  <div style={{ backgroundColor: '#121212', padding: '12px 14px', borderRadius: '8px', border: '1px solid #3a3a3c' }}>
                    <div style={{ fontSize: '10px', color: '#86868b', fontWeight: '700' }}>HOURS INTERVAL</div>
                    <div style={{ fontSize: '22px', fontWeight: '800', color: toolHours >= 250 ? '#ff3b30' : '#34c759' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', marginTop: 'auto' }}>
                    ...
                    <button 
                      ...
                      style={{ padding: '12px 16px', borderRadius: '8px', border: '1px solid #007aff', backgroundColor: 'transparent', color: '#007aff', fontSize: '12px', fontWeight: '800', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' }}
                    >
                ...
                <div className="card-face card-back">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #3a3a3c', paddingBottom: '12px', marginBottom: '16px' }}>
                    <span style={{ fontSize: '13px', fontWeight: '800', color: '#007aff' }}>🤖 AWS Bedrock AI Checklist</span>
                    <button onClick={() => setToolsFlipped(false)} style={{ background: 'none', border: 'none', color: '#86868b', cursor: 'pointer', fontSize: '13px' }}>⤶ Back</button>
                  </div>

                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', backgroundColor: '#121212', padding: '14px', borderRadius: '8px', marginBottom: '16px', fontSize: '13px' }}>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
                      <input type="checkbox" checked={toolChecklist.step1} onChange={e => setToolChecklist({...toolChecklist, step1: e.target.checked})} style={{ width: '16px', height: '16px' }} />
                      Hydraulic line pressure check
                    </label>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
                      <input type="checkbox" checked={toolChecklist.step2} onChange={e => setToolChecklist({...toolChecklist, step2: e.target.checked})} style={{ width: '16px', height: '16px' }} />
                      Repack grease points
                    </label>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
                      <input type="checkbox" checked={toolChecklist.step3} onChange={e => setToolChecklist({...toolChecklist, step3: e.target.checked})} style={{ width: '16px', height: '16px' }} />
                  ...
                  <button 
                    ...
                    style={{ marginTop: 'auto', padding: '12px', borderRadius: '8px', border: 'none', backgroundColor: (toolChecklist.step1 && toolChecklist.step2 && toolChecklist.step3) ? '#34c759' : '#3a3a3c', color: '#fff', fontSize: '13px', fontWeight: '800', cursor: 'pointer' }}
                  >
        ...
        {activeTab === "inventory" && (
          <div style={{
            ...
            {/* FULL-SIZE INTERACTIVE INVENTORY CARD */}
            <div className="card-perspective-wrapper">
              <div className={`card-flipper ${inventoryFlipped ? 'flipped' : ''}`}>
                ...
                <div className="card-face card-front" style={{ backgroundColor: '#2c2c2e', border: '1px solid #3a3a3c', padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <span style={{ backgroundColor: 'rgba(52,199,89,0.2)', border: '1px solid #34c759', color: '#34c759', padding: '3px 10px', borderRadius: '10px', fontSize: '10px', fontWeight: '900' }}>🟢 PICK FIRST</span>
                  </div>
                  ...
                  <div style={{ fontSize: '32px', fontWeight: '800', color: '#34c759' }}>
                    {stockQty} <span style={{ fontSize: '14px', color: '#86868b' }}>Boxes in Stock</span>
                  </div>

                  <div style={{ fontSize: '12px', color: '#007aff' }}>📍 Cooler Bay-01 ({stockQty}bx)</div>

                  {/* Interactive Action Deck */}
                  <div style={{ display: 'flex', gap: '8px', marginTop: 'auto' }}>
                    <button onClick={() => setStockQty(stockQty + 10)} style={{ flex: 1, padding: '10px', borderRadius: '8px', border: '1px solid #34c759', backgroundColor: 'rgba(52,199,89,0.15)', color: '#34c759', fontWeight: '800', fontSize: '12px', cursor: 'pointer' }}>+10 RCV</button>
                    <button onClick={() => setStockQty(Math.max(0, stockQty - 10))} style={{ flex: 1, padding: '10px', borderRadius: '8px', border: '1px solid #ff3b30', backgroundColor: 'rgba(255,59,48,0.15)', color: '#ff3b30', fontWeight: '800', fontSize: '12px', cursor: 'pointer' }}>-10 SHP</button>
                    <button onClick={() => setInventoryFlipped(true)} style={{ padding: '10px 16px', borderRadius: '8px', border: '1px solid #007aff', backgroundColor: '#007aff', color: '#fff', fontWeight: '800', fontSize: '12px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <RotateCw size={14} /> Flip
                    </button>
                  </div>
                </div>
                ...
                <div className="card-face card-back">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #3a3a3c', paddingBottom: '12px', marginBottom: '16px' }}>
                    ...
                    <button onClick={() => setInventoryFlipped(false)} style={{ background: 'none', border: 'none', color: '#86868b', cursor: 'pointer', fontSize: '13px' }}>⤶ Back</button>
                  </div>

                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                    <div style={{ backgroundColor: '#121212', padding: '12px', borderRadius: '8px' }}>
                      <div style={{ fontSize: '10px', color: '#86868b' }}>30-DAY BURN</div>
                      <div style={{ fontSize: '18px', fontWeight: '800' }}>75 bx</div>
                    </div>
                    <div style={{ backgroundColor: '#121212', padding: '12px', borderRadius: '8px' }}>
                      <div style={{ fontSize: '10px', color: '#86868b' }}>90-DAY BURN</div>
                      <div style={{ fontSize: '18px', fontWeight: '800' }}>225 bx</div>
                    </div>
                  </div>

                  {showZebraPreview && (
                    <div style={{ backgroundColor: '#fff', color: '#000', padding: '12px', borderRadius: '8px', textAlign: 'center', marginBottom: '16px' }}>
                      <div style={{ fontSize: '11px', fontWeight: '800' }}>CITRUS SPRINGS — ORANGE JUICE</div>
                      <div style={{ fontSize: '10px', fontFamily: 'monospace' }}>UPC: 082123456781</div>
                    </div>
                  )}

                  <button onClick={() => setShowZebraPreview(!showZebraPreview)} style={{ marginTop: 'auto', padding: '12px', borderRadius: '8px', border: 'none', backgroundColor: '#1c1c1e', border: '1px solid #3a3a3c', color: '#fff', fontSize: '12px', fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
