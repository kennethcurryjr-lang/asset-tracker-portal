        ...
        {isSuperAdmin && (
          <div style={{ 
            ...
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "4px", backgroundColor: "#2c2c2e", borderRadius: "12px", padding: "4px", boxShadow: "0 4px 14px rgba(0,0,0,0.4)", maxWidth: "100%" }}>
              <button onClick={() => setActivePortal("tools")} style={{ padding: "8px 24px", borderRadius: "10px", border: "none", cursor: "pointer", fontWeight: "600", backgroundColor: activePortal === "tools" ? "#ffcc00" : "transparent", color: activePortal === "tools" ? "#1d1d1f" : "#8e8e93", transition: "all 0.2s", whiteSpace: "nowrap" }}>Kinetic Tools</button>
